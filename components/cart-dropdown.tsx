      ...
      {isOpen && (
        <>
          ...
          <motion.div
            ...
            className="absolute right-0 sm:right-auto top-full mt-2 w-[calc(100vw-2rem)] sm:w-96 max-w-md rounded-lg border border-border bg-background shadow-lg z-50"
          >
            <div className="p-4">
